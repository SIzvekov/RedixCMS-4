...
?>
<tr><td class="imgtd">
<a href="/<?=$filepath?>/<?=$row['img']?>" target="_blank"><div class="ph_set_img"><img src="/<?=$filepath?>/<?=$row['img']?>?w=150" width="150" alt="<?=$this->fmgr_filenames[$row['img']]?>"/><div class="ph_set_imgname"><?=$this->fmgr_filenames[$row['img']]?></div></div></a>
</td><td>
