...
foreach($tree as $item)
{
	...
	*/
	...
	$menu_tree .= "<div id='linkspan-".$item['id']."'>".str_repeat("&nbsp;&nbsp;",$item['this_space'])."<span id='linksort-".$item['id']."'>".$item['sort']."</span>. <span id='linktext-".$item['id']."'> ".(!$item['link']?"<b>":"").$item['text']."</b></span> <font color='#cfcfcf'><span id='linklink-".$item['id']."'>".$item['link']."</span><a href='#' onclick=\"editlink('".$item['id']."',1);return false;\"><img src=\"http://".HTTP_HOST."/".$this->adm_path."/template/".$this->config['adm_tpl']."/img/tree_edit/edit10px.png\" border='0' align='absmiddle'></a>
...
$menu_tree .= "</div><br><b>Добавить пункт:</b><br><font style='color:#cfcfcf;font-size:9px;'>Сорт.&nbsp;
Текст&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Ссылка&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Родитель</font><br>";
...
$adm_rights_tree .= "</table><br><b>Добавить:</b><br>";

$adm_rights_tree .= "<div id='addrway' style='display:block'><font style='color:#cfcfcf;font-size:9px;'><b>Путь</b> | <a href='#' style='color:#cfcfcf' onclick=\"ppswitch();return false;\">Параметр</a></font><br>";
...
$adm_rights_tree .= "<div id='addrpar' style='display:none'><font style='color:#cfcfcf;font-size:9px;'><a href='#' style='color:#cfcfcf' onclick=\"ppswitch();return false;\">Путь</a> | <b>Параметр</b></font><br>";
...
function savelink(id)
{
	...
	else  document.getElementById('linktext-'+id).innerHTML = '<b>'+document.getElementById('text-'+id).value+'</b>';
